...
SELECT e.emp_no, e.first_name, de.dept_no FROM employees e, dept_emp de; 

SELECT e.emp_no, e.first_name, de.to_date 
FROM employees e
JOIN dept_emp de
...
SELECT d.dept_name, COUNT(*) AS 사원수 
FROM employees e
...
SELECT e.gender, e.first_name, de.dept_name
FROM employees e
JOIN dept_emp d
...
SELECT first_name, dept_name, to_date  
FROM employees e
JOIN dept_emp d
ON e.emp_no = d.emp_no  
JOIN departments de 
...
SELECT e.first_name, d.dept_no, s.salary
FROM employees e
JOIN dept_emp d
ON e.emp_no = d.emp_no
JOIN salaries s
